...
const questions = [
  {
    id: 56,
    questionText: "Kunden der Fluaggeselschaft DL äußern Unzufriedenheit",
    options: [
      {
        optionID: "richtig",
      },
  ...
  },
  {
    id: 57,
    questionText:
      "Die Preise von Süßwaren warden dieses Jahr gesenkt,um Käufer Zurückzugewinnen.",
    options: [
      {
        optionID: "richtig",
      },
  ...
  {
    id: 58,
    questionText: "Die Sonnenstürme hatten keine negativen Auswirkungen",
    options: [
      {
        optionID: "richtig",
      },

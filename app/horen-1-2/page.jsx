...
const questions = [
  {
    id: 56,
    questionText: "Frau Jürgens tritt wegen Streitigkeiten zurück.",
    options: [
      {
        optionID: "richtig",
      },
  ...
  {
    id: 57,
    questionText: "Die Filme werden in den Kinos der Stadt gezeigt.",
    options: [
      {
        optionID: "richtig",
      },
  ...
  {
    id: 60,
    questionText: "Die Temperaturen steigen in den nächsten Tagen an.",
    options: [
      {
        optionID: "richtig",
      },

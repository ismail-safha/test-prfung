...
const Sprachbauchteine_2: React.FC = () => {
  ...
  return (
    <div className="container m-auto  w-full px-2">
      <Header
        pageHome="/lesen-test"
        pageTow="/lesen-test/lesenteil-2"
        pageThree="/lesen-test/lesenteil-3"
        pageFour="/lesen-test/sprachbauchteine-1"
        pageFive="/lesen-test/sprachbauchteine-2"
      />
      <main>
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-[20px]">
          ...
          <div className="w-full lg:w-[55%] mt-[20px]">
            ...
            <div className="mt-[30px] dark:bg-[#1d2a35] dark:text-[#ededed] bg-[#fbfbfb] rounded-lg lg:overflow-y-scroll h-fit  lg:h-[500px] p-4">
              ...
              <p>
                Überall gibt es inzwischen Bio-Lebensmittel - aber häufig fehlen
                den Käufern Hintergrundinformationen. Viele Verbraucher fragen
                sich beispielsweise,{" "}
                <input
                  type="text"
                  placeholder="____31"
                ...
                <input
                  ...
                  readOnly
                />{" "}
                sind Bio-Produkte teurer - und den Aufpreis will man nur zahlen,
                wenn man sicher ist, dass die Bio-Lebensmittel die bessere Wahl
                sind. Der Informationsdienst der Bundesministeriums für
                Ernährung, Landwirtschaft und Verbraucherschutz gibt darüber
                eine eindeutige Auskunft: Bio-Lebensmittel sind gesünder. Sie{" "}
                <input
                  type="text"
                  placeholder="____33"
                  className={`bg-blue-500 rounded-[9px] w-16 text-center mx-2 ${
                ...
                man Allergien hat. Doch Bio-Lebensmittel sind nicht nur gut für
                die Gesundheit. Bei vielen Verbrauchern steht{" "}
                <input
                  type="text"
                  placeholder="____34"
                  className={`bg-blue-500 rounded-[9px] w-16 text-center mx-2 ${
                ...
                Lebensmittel, denn auch die umweltfreundliche Landwirtschaft ist
                besser für Tiere und Pflanzen, kurz: Sie{" "}
                <input
                  type="text"
                  placeholder="____35"
                  className={`bg-blue-500 rounded-[9px] w-16 text-center mx-2 ${
                ...
                steht. Die Mindestrichtlinien der Bio-Landwirtschaft beinhalten
                eine artgerechte Tierhaltung: Alle Tiere müssen ausreichend
                Platz haben, es gibt keine langen Tiertransporte, keine
                Gentechnik. Die Produkte werden möglichst in der näheren
                ...
                übrigens auch ein Zertifikat, das Bio-Siegel. Diese Richtlinien
                garantieren,{" "}
                <input
                  type="text"
                  placeholder="____40"

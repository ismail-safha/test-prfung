...
const questions = [
  ...
  {
    id: 58,
    questionText: "Die Teilnahme an der Party im Burghof kostet nichts.",
    options: [
      {
        optionID: "richtig",
      },
  ...
  },
  {
    id: 59,
    questionText:
      "In Bamberg kann man in der nächsten Woche besonders günstig Mitglied in einem Sportverein werden.",
    options: [
      {
        optionID: "richtig",
      },

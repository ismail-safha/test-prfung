...
import { sprachbau_2 } from "../../data/Insekten_H/sport-ist-gesund-1-1-Data";
          ...
          <DndContext onDragEnd={handleDragEnd}>
            <div className="flex justify-between gap-[20px]">
              ...
              <div className="w-[55%] mt-[20px]">
                ...
                <div className="mt-[30px]   dark:bg-[#1d2a35]  dark:text-[#ededed] bg-[#fbfbfb] rounded-lg h-fit">
                  <h1 className="font-bold pb-1">
                    {sprachbau_2.texts[0].title}
                  </h1>

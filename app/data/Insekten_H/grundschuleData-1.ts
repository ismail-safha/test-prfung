  ...
  carts: [
    {
      ...
      `,
      cartItemAnswers: "",
      cartAcoordion: "Gewerkschaft erwartet Lehrermangel in Berlin",
    },
    {
      id: 1,
      idText: "2",
...
Bilderbuch darbietet, genießen. Erleben Sie die Einzigartigkeit der atemberaubenden Gebirgsketten, der 
artenreichen Tierwelt und der idyllisch gelegenen Hafenstädte, die wir im Liniendienst anfahren. Buchen 
Sie innerhalb der nächsten 6 Wochen - und sichern Sie sich Ihre Wunschkabine und einen 
Frühbucher-Bonus bis 25%. Information, aktueller Katalog und Buchung unter: Tel.: (040) 367 53-496, 
E-Mail: info@eiligruten.de, www.eiligruten.de
      `,
      cartItemAnswers: "",
      cartAcoordion:

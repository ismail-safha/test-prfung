...
export const sprachbau_1 = {
  ...
  aufgabens: [
    ...
    },
    {
      ...
      answersOne: `durften`,
      answersTwo: "konnten",
      answersThree: "soltten",
    },
    {
      id: 9,
      qustion: "30",
      answersOne: `inzwischen`,
      answersTwo: "während",
      answersThree: "zwischen",
    },
  ],
};
  ...
  texts: [
    {
      title: "Im Restaurant",
      text: ` 
      Eine unterhaltsame, schöne und gesellige Zeit. Das stellt man sich unter einem guten Essen vor. Störend wirkt da der anschauliche Erlebnisbericht der letzten Operation im Krankenhaus oder das Klingeln des Handys. Sowohl Gastgeber als Gast sollen alles dafür tun, dass das gemeinsame Essen Freude macht. Das Handy stellt man selbstverständlich ab. 
      Das Essen beginnt, wenn der Gastgeber zur Serviette greift oder zum Gruß sein Glas erhebt. Besonders bei Kindern ein unbeliebtes Thema: die richtige Körperhaltung beim Essen. Die Arme 
      31_________ nicht auf den Tisch und die Hände nicht unter den Tisch. Mal sitzt gerade, ohne unruhig hin und her zu rücken. Die Beine werden nebeneinander gestellt, nicht übereinander gelegt. Die Schuhe 32_________ in jedem Fall an. 
      Nur keine Angst vor guten Restaurants mit ihrem Luxus! Denn je besser die Küche, umso aufmerksamer ist in der Regel das Personal. Doch schon bei der Anrede der Bedienung steht so 
      33_________ vor einem Problem. Die Bedienung 34_________ "Fräulein" an den Tisch zu rufen, ist in Zeiten dert Gleichberechtigung veraltet. "Herr Ober" oder" Bedienung" ist 35_________ noch möglich, aber auch schon etwas ungewöhnlich. Am besten versucht man sich Blickkontakt zu verschaffen, um mit einem kleinen 36_________ mit der Hand den Kellner an den Tisch zu bitten. 
      Zudem gibt es zwischen Gast und Service eine Zeichensprache. Schließt der Gast die Speisekarte und legt sie auf den Tisch, ist dies für den Kellner das Signal, die Bestellung aufzunehmen. Ist man mit dem Essen 37_________, legt man das Besteck parallel nebeneinander auf den rechten Tellerrand. Der Kellner wir dann abräumen. Macht man hingegen nur eine Pause, wird es gekreuzt oder offen auf den Teller gelegt. 
      Beim Bezahlen ist 38_________ gefragt. Übernimmt ein Gastgeber die Kosten, macht er dies dem Kellner 39_________. Ein "Bringen Sie mir bitte die Rechnung" reicht da völlig aus. Möchte man hingegen getrennt bezahlen, 40_________ durchaus üblich ist, teilt man dies ebenfalls rechtzeitig der Bedienung mit. In Deutschland gibt man, je nach Zufriedenheit mit dem Service und der Höhe der Gesamtsumme zwischen drei und zehn Prozent Trinkgeld. Ist man mit dem Service unzufrieden gewesen, gibt man kein Trinkgeld. `,
    },
  ],
  Answers: [
    {

...
export const lesenTeil_3 = {
  carts: [
    ...
    },
    {
      ...
      `,
      cartItemAnswers: "",
      cartAcoordion: "Sie möchten mithelfen, Ihre Stadt schöner zu machen.",
    },
    {
      id: 10,
      idText: "K",
  ...
  answers: [
    ...
    {
      id: 4,
      text: "Sie möchten mithelfen, Ihre Stadt schöner zu machen.",
      number: "14",
    },
    {
      id: 5,
...
export const lesenTeil_2 = {
  texts: [
    {
      ...
      text: `In der öffentlichen Beschreibung kennt man die Familie oft als Problemzone. Bestsellerautoren
  ...
  questions: [
    {
      id: 0,
      questionText: "Etwa die Hälfte der Senioren über 60 gibt an, dass sie",
      options: [
        {
          optionID: "A",
          option: "ihre Kinder strenger erziehen würden.",
        },
        {
          optionID: "B",
          option: "die geänderten Erziehungsmethoden begrüßen.",
        },
        {
          optionID: "C",
          option: "als Kind glücklich waren",
        },
      ],
      correctAnswerID: "C",
    },
    {
      id: 1,
      questionText: "Die meisten Jugendlichen",
      options: [
        {
          optionID: "A",
          option: "verstehen sich mit ihren Eltern gut",
        },
        {
          optionID: "B",
          option: "haben keine Meinung zu Erziehungsfragen",
        },
        {
          optionID: "C",
          option: " denken, dass man auch ohne Familie glücklich sein kann",
        },
      ],
      correctAnswerID: "A",
    },
    {
      id: 2,
      questionText: "Heute gibt es zwischen Eltern und Kindern",
      options: [
        {
          optionID: "A",
          option: "Konflikte wegen unterschiedlicher Werte",
        },
        {
          optionID: "B",
          option: "kaum Unterschiede in der Lebensart.",
        },
        {
          optionID: "C",
          option: "immer wieder Probleme wegen zu engen Wohnraums.",
        },
      ],
      correctAnswerID: "B",
    },
    {
      id: 3,
      questionText: "Mütter haben heute mehr Zeit für ihre Kinder, weil",
      options: [
        {
          optionID: "A",
          option: "sie in der Arbeit weniger Stress haben",
        },
        {
          optionID: "B",
          option: "Geräte die Hausarbeit leichter machen",
        },
        {
          optionID: "C",
          option: "die Großeltern ihnen Arbeit abnehmen.",
        },
      ],
      correctAnswerID: "B",
    },
    {
      id: 4,
      questionText: "In der Öffentlichkeit",
      options: [
        {
          optionID: "A",
          option: " wird der Wandel in der Erziehung nicht wahrgenommen.",
        },
        {
          optionID: "B",
          option: "ist das Thema Familie nicht interessant",
        },
        {
          optionID: "C",
          option: "entsteht oft ein falsches Bild der Familie",
        },
      ],
      correctAnswerID: "C",
    },

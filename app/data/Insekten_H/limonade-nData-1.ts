...
21.00 NDR
Ferner haben sie Zeitzeugen nach ihren Reaktionen auf das einschneidende Ereignis befragt. Zu
Wort kommen in dem Film nicht nur namhafte Vertreter der internationalen Politik, sondern
auch Grenzsoldaten, Flüchtlinge und Angehörige von Maueropfern.
      `,
      cartItemAnswers: "",
      cartAcoordion:
...
Schlagersängerin Michelle mit dem Titel "Ich schicke dir jetzt einen Engel".
    ...
    },
    {
      ...
      Gourmet-Restaurants an der Fifth Avenue, kommt als einer der ersten in deren Genuss.
      Amanda hat sich in ihn verliebt, als der schon bekannte Krebs unter Toms Hosenbein flüchtet.
    ...
    },
    {
      ...
      Augen zu dem Versteck gebracht. Aber auch einige Gangster sind nicht untätig. Sie haben es auf
...
Katastrophen mit Bravour und Geduld. Weil sich Kind und Karriere nicht unter einen Hut bringen
ließen, verlor der Jurist einen tollen Job in einer renommierten Chicagoer Anwaltskanzlei. Jetzt
sitzt er mit seinem Sohn in einem Dorf in Kansas und arbeitet in der Kanzlei eines Freundes. Die
Bekanntschaft mit der attraktiven Beth bringt neuen Schwung in sein Leben. Doch da taucht
...
Gefängnis und finden als Mönche getarnt Unterschlupf in einer Missionsstation.`,
      cartItemAnswers: "",
      cartAcoordion:
...
Nazis die Macht ergreifen, stellt Höfgen seine Kunst ganz in den Dienst der neuen Herrscher.
Und bald wird er zum Intendanten des Staatstheaters ernannt. Das Drama um Kunst und
Politik entstand nach dem gleichnamigen Roman von Klaus Mann.
      `,
      cartItemAnswers: "",
      cartAcoordion:
  ...
  texts: [
    {
      ...
      text: `Den Partner für das Leben finden - für immer mehr Menschen wird dies offenbar immer schwieriger. Rund
      31 Millionen Männer und Frauen in Deutschland, also mehr als ein Drittel der gesamten Bevölkerung, sind
      alleinstehend. Nicht dass Mann oder Frau wählerischer als in früheren Zeiten geworden wäre, es gibt
      scheinbar ganz einfach immer weniger Gelegenheiten, das Ziel einer Partnerschaft oder Ehe zu erreichen.
      Die Menschen haben einfach immer weniger Zeit, sich um ihre ganz natürlichen Wünsche zu kümmern.
      Viele arbeiten weit entfernt von ihrem Wohnort, wechseln die Arbeitsstätte in relativ kurzen Abständen,
      haben für das Privatleben ungünstige Arbeitszeiten mit wenig Freizeit - abgesehen vom alljährlichen
      Urlaub. Dazu kommt, dass eine beträchtliche Minderheit der Deutschen nicht bereit ist, sich längerfristig
      oder gar "lebenslänglich" an einen bestimmten Partner zu binden. Immer mehr Menschen leben lieber mit
      ihren Lebensabschnittgefährten zusammen oder sie bevorzugen saisonale Kurzbeziehungen nach dem
      Muster "öfter mal 'ne(n) Neue(n)".
      Und immer mehr von denen, die eine Partnerschaft anstreben, versuchen ihren Liebsten oder ihre Liebste
      nicht auf Partys, Kirmesfesten oder in Cafés und Kneipen zu finden, wie das bei ihren Großeltern noch
      üblich war, sondern sie schauen ins Internet oder in Zeitungen, um über Partnerschafts- oder
      Heiratsannoncen fündig zu werden. In Deutschland gibt es viele Radioprogramme, in denen täglich
      Dutzende ihre Heiratsabsichten kundtun. An Wochenenden gibt es sogar Fernsehsendungen, in denen
      Partnersuchende mit anderen Partnersuchenden quasi verkuppelt werden.
      Doch wie muss solch eine Kontaktanzeige aussehen, damit sie auch von Erfolg gekrönt ist? Denn nicht
      wenige Anzeigen bringen gar keinen oder nicht den erwünschten Erfolg. Dieser Frage hat sich nun der
      Kommunikationsexperte Jörg Stimpfling an der Universität Stuttgart gewidmet und seit mehr als zehn
      Jahren Kontaktanzeigen in den verschiedensten Medien gesammelt und analysiert.
      Das Ergebnis der umfangreichen Forschung: Viele Anzeigen sind zu oberflächlich formuliert oder bedienen
      sich althergebrachter Stereotypen. So beschreiben sich Frauen mit Synonymen für Schönheit oder
      Attraktivität, Männer bieten Sicherheit oder Status an, überholt geglaubte Klischees finden sich in den
      meisten Fällen. Ebenso fällt die Neigung auf, sich schöner, besser zu präsentieren, als man wirklich ist, so
      als biete man ein Produkt in der Konsumwerbung an. Man könnte fast meinen, viele suchen sich selbst wie
      ihr eigenes Zwillingsbild.
      Jörg Stimpfling und seine Kollegen empfehlen Partner suchenden Singles daher, sich erst einmal selbst
      kennen zu lernen, bevor sie sich an zukünftige Partnerinnen oder Partner wenden. Nur wer über sich selbst
      Bescheid weiß, kann den Partner finden, der zu ihm passt. Und das Zwillingsbild im Spiegel ist leider kaum
      als idealer Partner geeignet.
      `,
    },
  ],
  questions: [
    {
      id: 0,
      questionText:
        "Viele Singles suchen sich heute ihre Partner oder Partnerinnen",
      options: [
        {
          optionID: "A",
          option: "die Ansprüche bei der Partnerwahl immer weiter steigen",
        },
        {
          optionID: "B",
          option:
            "die Lebensumstände es erschweren, eine Partnerin oder einen Partner zu finden",
        },
        {
          optionID: "C",
          option:
            "die meisten ohnehin lieber in zeitlich begrenzten Beziehungen leben.",
        },
      ],
      correctAnswerID: "B",
    },
    ...
    {
      id: 2,
      questionText: "Im Radio werden",
      options: [
        {
          optionID: "A",
          option: "an Samstagen und Sonntagen Partner vermittelt.",
        },
        {
          optionID: "B",
          option: "jeden Tag Heiratswünsche gesendet.",
        },
        {
          optionID: "C",
          option: "täglich Hochzeitsglückwünsche gesendet",
        },
      ],
      correctAnswerID: "B",
    },
    {
      id: 3,
      questionText: "In Kontaktanzeigen",
      options: [
        {
          optionID: "A",
          option:
            "beschreiben sich Partnersuchende oft im Rahmen konventioneller Rollenerwartungen.",
        },
        {
          optionID: "B",
          option: "suchen die meisten Männer moderne, attraktive Frauen",
        },
        {
          optionID: "C",
          option:
            "werden recht häufig die passenden Partner fürs Leben gefunden.",
        },
      ],
      correctAnswerID: "A",
    },
    {
      id: 4,
      questionText: "Wer eine Kontaktanzeige aufgibt, sollte",
      options: [
        {
          optionID: "A",
          option: "jemanden suchen mit möglichst ähnlichen Eigenschaften",
        },
        {
          optionID: "B",
          option: "sich werbewirksam präsentieren können",
        },
        {
          optionID: "C",
          option: "zunächst eine Selbstanalyse vornehmen.",
        },
      ],
      correctAnswerID: "C",
    },

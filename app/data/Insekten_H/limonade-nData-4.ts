  ...
  carts: [
    {
      id: 0,
      idText: "A",
      titleText: `Gerlinde Kaltenbrunner`,
      title: `
      ...
      cartItemAnswers: "",
      cartAcoordion:
        "Sie möchten mehr über die psychischen Aspekte von Klettersport erfahren.",
    },
    {
      id: 1,
      idText: "B",
      titleText: "Seniorenwohnhaus 'Zur alten Linde'",
      title: `
    ...
    },
    {
      id: 4,
      idText: "E",
      titleText: "Nervenkitzel beim Bungee Jumping",
      title: `
    ...
    },
    {
      id: 6,
      idText: "G",
      titleText: "Spektakuläre Feuerwehrübung",
      title: `
      ...
      cartItemAnswers: "",
      cartAcoordion:
        "Sie interessieren sich für Videos von besonderen Rettungseinsätzen.",
    },
    {
      id: 7,
      idText: "H",
      titleText: "Helfer und Helferinnen gesucht",
      title: `
      Für unseren Halbmarathon am 20. Juli suchen wir noch Freiwillige, die uns bei der Benefizveranstaltung unterstützen möchten. Es gibt viele Bereiche, in denen ihr uns helfen könnt: vom Aufbau von Zuschauerbarrieren über Streckensicherung und Startnummerausgabe bis zum Einsatz an den Verpflegungsposten - jede helfende Hand ist uns herzlich willkommen. Die Veranstaltung dient einem guten Zweck. Die Startgelder und 10 Prozent der Einnahmen aus der Gastronomie gehen an gemeinnützige Vereine unserer Stadt. Anmelden könnt ihr euch auf der Webseite der Stadtverwaltung unter Veranstaltungen/Halbmarathon/Freiwillige.
      `,
      cartItemAnswers: "",
      cartAcoordion:
        "Ein Freund von Ihnen möchte gerne bei einer Sportveranstaltung mitarbeiten.",
    },
    {
      id: 8,
      idText: "I",
      titleText: "Märchenwanderung für Kinder von 8 bis 12 Jahren",
      title: `
      Wir wandern entlang des Märchenwanderwegs, der durch eine abwechslungsreiche Landschaft führt, mit herrlicher Aussicht auf die Berge. Am Ende des Weges gelangen wir zu einem Wildgehege. Was ihr braucht: feste Schuhe, bei unbeständigem Wetter einen Regenschutz (bitte keine Schirme) und Kleidung, die ruhig schmutzig werden darf. Treffpunkt: vor der Kirche, um 10.00 Uhr. Dauer: 4 Stunden (Wander- und Erzählzeit). Teilnahmegebühr: 17 Euro inklusive Mittagessen. Leitung: Märchentante Gerlinde, unterstützt von zwei freiwilligen Helferinnen. Wir wandern ohne Eltern oder Begleitpersonen.
      `,
      cartItemAnswers: "",
      cartAcoordion: "",
    },
    {
      id: 9,
      idText: "J",
      titleText: "Aktion 'Sauberes Grün'",
      title: `
      ...
      Unsere jährliche Aktion für eine saubere Stadt, dieses Jahr vom 2. bis 4. Mai. Anmeldungen bei den städtischen Reinigungsbetrieben: 0240-191980.
      `,
      cartItemAnswers: "",
      cartAcoordion:
        "Sie möchten dazu beitragen, Ihre Stadt schöner zu machen.",
    },
    {
      id: 10,
      idText: "K",
      titleText: "Tag der offenen Tür in der städtischen Bücherei",
      title: `
      ...
      cartItemAnswers: "",
      cartAcoordion:
        "Ihre sechzehnjährige Cousine beschäftigt sich gerne mit kleinen Kindern.",
    },
    {
      id: 11,
      idText: "L",
      titleText: "150 Jahre Stadtfeuerwehr",
      title: `
      Zum Jubiläum 150 Jahre Stadtfeuerwehr laden die Feuerwehr und der Katastrophenschutz zu einer Leistungsschau. Zu besichtigen: das "brandneue" Löschfahrzeug, das auch dank der großzügigen Unterstützung von Sponsoren angeschafft werden konnte. Weiter: einige abenteuerliche Bergungen durch aktive Mitglieder der Freiwilligen Feuerwehr. Dann eine spektakuläre Löschaktion. Und zum Schluss: Grillfeuer für alle!
      Wann? Samstag, 23. Juli ab 16.00 Uhr, am alten Messegelände.
      Die Freiwillige Feuerwehr hofft auf großes Interesse!
      `,
      cartItemAnswers: "",
      cartAcoordion:
        "Ihr kleiner Bruder möchte einmal ein Feuerwehrauto aus der Nähe sehen.",
    },
  ],
  answers: [
    {
  ...
  texts: [
    {
      ...
      Konto. Die Kontoverbindung finden Sie unten auf dem Anmeldeformular. _________ besserer
      Einschätzung Ihrer Vorkenntnisse haben wir einen Einstufungstest beigelegt.
      Wenn Sie die Tetsbögen ausfüllen und mit der Anmeldung an uns zurücksenden, helfen Sie uns
      bei der Kursplanung. Ein mündlicher Test wird sich am ersten Unterrichtstag in unserer Schule
      _________ . Damit sind wir in der Lage, den für Sie angemessenen Kurs auszuwählen. Außerdem
      finden Sie in den Unterlagen einen Fragenbogen _________ Ihrer Freizeitinteressen. Wir werden
      uns bemühen, Ihnen den Aufenthalt in Leipzig so angenehm _________ möglich zu gestalten.
      Schließlich füllen Sie bitte das grüne Unterkunftblatt aus. Sie können wählen zwischen einem
      3-Sterne-Hotel, _________ Privatunterkunft in einer deutschen Gastfamilie oder der Unterkunft
      in einem Studentenwohnheim. Letzteres ist nur in den Semesterferien der Universität - in der
      Regel vom 15.2. bis 15.4. und vom 15.7. bis 15.10. - möglich. Geben Sie bitte auch Ihre
      Verpflegungswünsche - Frühstück oder Halbpension - an. Beachten Sie aber, dass im
      Studentenwohnheim nur Selbstverpflegung möglich ist.
      _________ Ihre Anmeldung bei uns eingegangen ist, erhalten Sie eine Anmeldebestätigung und
      einen Stadtplan mit Wegbeschreibung, _________ Sie den Weg zu uns ohne Umstände finden.
      Die Adresse Ihrer Unterkunft erhalten Sie ca. 2 Wochen vor Kursbeginn.
      _________ weitere Fragen steht Ihnen unser Sekretariat gerne montags bis freitags von 8 bis 18
      Uhr zur Verfügung.

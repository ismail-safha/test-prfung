  ...
  carts: [
    {
      ...
      Springen - sie schnarren also - und man sieht 
      ...
      ausschließlich für die Heuschrecken tödlich ist, 
    ...
    },
    {
      ...
      cartItemAnswers: "",
      cartAcoordion: "Kleine Plagegeister können Krankheiten bringen",
    },
    {
      id: 3,
    ...
    {
      id: 4,
      title: `Heute und morgen tagt in Göteborg die Internationale Nordseekonferenz (INK), an der Regierungsvertreter der acht 
  ...
  carts: [
    {
      ...
      `,
      cartItemAnswers: "",
      cartAcoordion: "Sie möchten durch Europa reisen und privat übernachten.",
    },
    {
      id: 1,
      title: `
...
nach Hause und machen Ihnen ein kostenloses Angebot! www.schreiner.de
    ...
    },
    {
      ...
      cartItemAnswers: "",
      cartAcoordion:
        "Sie möchten mit Freunden durch Deutschland reisen und dabei günstig übernachten.",
    },
    {
      id: 7,
  ...
  answers: [
    "Einem Bekannten wurde die Arbeitsstelle gekündigt. Er möchte bei einem Anwalt um Rat fragen.",
    `Ihr Bekannter ist beruflich oft unterwegs und sucht eine Alternative zu Hotels. Es soll dort 
    aber Internetzugang und Frühstück geben`,
    "X: Sie reisen gerne und oft und möchten nun Informationen zu einer Reiseversicherung",
    "Sie möchten durch Europa reisen und privat übernachten.",
...
export const lesenTeil_2 = {
  texts: [
    {
      title: "Müdigkeit und juckende Augen - Arbeit in Großraumbüros",
      text: `
...
Beschäftigten in Großraumbüros deutlich höher als bei anderen.
      `,
      titleTow: "Die deutsche Sehnsucht nach dem Einzelbüro",
      textTow: `
  ...
  aufgabens: [
    {
      id: 0,
      qustion: "Eine Studie aus der Schweiz...",
      answersOne: `belegt, dass die Mitarbeiter sich über Lärm im Großraumbüro beklagen`,
      answersTwo:
    ...
    {
      id: 1,
      qustion: "Großraumbüros…",
      answersOne: `reduzieren den Krankenstand`,
      answersTwo: "sind kostengünstiger zu beheizen. ",
      answersThree: "werden immer seltener",
    },
    {
      id: 2,
      qustion: "Die deutschen Angestellten…",
      answersOne: `bevorzugen Einzelbüros.`,
      answersTwo: "genießen eine individuell ausgewählte Büromöblierung",
      answersThree: "leiden unter zu engen Einzelbüros",
    },
    {
      id: 3,
      qustion: "Die Arbeitsplatzfläche…",
      answersOne: `ist in Londoner Großraumbüros für den Chef größer als für andere Mitarbeiter.`,
      answersTwo: "schließt die gemeinsam genutzten Flächen aus ",
      answersThree: "wird in London oft unter mehreren Mitarbeitern aufgeteilt",
    },
    {
      id: 4,
      qustion: "Großraumbüros… ",
      answersOne: `gibt es vor allem in Banken und Telekommunikationsunternehmen.`,
      answersTwo: "werden bald in 40% der deutschen Firmen eingeführt.",
      answersThree: "werden meist in Einzelzellen unterteilt.",
    },
  ],
};
...
gemacht?
Als Kind war ich mit meinen Eltern mal wandern, aber mir hat das damals nicht ____23_____ 
...
lesen, in der Sonne liegen, ab und zu mal ins Wasser gehen - ____24_____ habe ich schon im 
Alltag genug Stress.
...
noch weiter ____25_____ als deine alte? Du musstest ja immer ziemlich lange fahren, daran 
erinnere ich mich noch gut!
Ich denke im Moment auch darüber nach, die Stelle zu ____26_____ . Mein Chef und meine 
Kollegen sind zwar total nett und die Bezahlung ist auch gut, aber ich mache fast jeden Tag das 
Gleiche - und das jetzt schon seit über zehn Jahren. Ehrlich ____27_____ langweile ich mich in den 
letzten Monaten immer häufiger und würde gerne noch mal etwas Neues ausprobieren. Deshalb 
mache ich ab dem ____28_____ Monat erst mal eine Weiterbildung, sonst hätte ich wohl nicht so 
gute Chancen, eine neue Stelle zu bekommen. Schließlich wird es auch immer schwieriger, 
____29_____ älter man ist. Die meisten Arbeitgeber wollen doch lieber jüngere Angestellte.
Wie ____30_____ es, wenn wir uns demnächst treffen würden? Wir könnten in diesem neuen 
...
Richard
  ...
  aufgabens: [
    ...
    },
    {
      id: 3,
      qustion: "24",
      answersOne: `allerdings `,
      answersTwo: "außerdem ",
      answersThree: "schließlich ",
    },
    {
      id: 4,
      qustion: "25",
      answersOne: `-`,
      answersTwo: "abgerückt ",
      answersThree: "entfernt ",
    },
    {
      id: 5,
      qustion: "26",
      answersOne: `ändern `,
      answersTwo: "verwechseln",
      answersThree: "wechseln",
    },
    {
      id: 6,
      qustion: "27",
      answersOne: `gesagt `,
      answersTwo: "sagend ",
      answersThree: "zu sagen",
    },
    {
      id: 7,
      qustion: "28",
      answersOne: `kommende `,
      answersTwo: "kommendem",
  ...
  texts: [
    {
      ...
      text: ` Überall gibt es inzwischen Bio-Lebensmittel - aber häufig fehlen den Käufern 
      Hintergrundinformationen. Viele Verbraucher fragen sich beispielsweise, 31_________ 
      Bio-Produkte nun auch wirklich die gesünderen sind. Skepsis macht sich breit, 
      spätestens wenn wieder einmal ein Skandal in den Nachrichten ist. 32_________ sind 
      Bio-Produkte teurer - und den Aufpreis will man nur zahlen, wenn man sicher ist, dass 
      die Bio-Lebensmittel die bessere Wahl sind. Der Informationsdienst der 
      Bundesministeriums für Ernährung, Landwirtschaft und Verbraucherschutz gibt darüber 
      eine eindeutige Auskunft: Bio-Lebensmittel sind gesünder. Sie 33_________ weniger 
      Nitrat, mehr Nährstoffe und sind besser geeignet, wenn man Allergien hat.
      Doch Bio-Lebensmittel sind nicht nur gut für die Gesundheit. Bei vielen Verbrauchern 
      steht 34_________ ihrem Einkaufsverhalten ein ökologisches Bewusstsein. 
      Bio-Verbraucher machen sich Gedanken über die Herkunft der Lebensmittel, denn auch 
      die umweltfreundliche Landwirtschaft ist besser für Tiere und Pflanzen, kurz: Sie 
      35_________ unsere Umwelt. Und viele Bio-Verbraucher wollen als gesunde Menschen in 
      einer gesunden Umwelt leben und auch der nächsten Generation eine gesunde Umwelt 
      hinterlassen.
      Bio-Lebensmittel kommen 36_________ ökologischer Landwirtschaft, die im Einklang mit 
      der Natur steht. Die Mindestrichtlinien der Bio-Landwirtschaft beinhalten eine 
      artgerechte Tierhaltung: Alle Tiere müssen ausreichend Platz haben, es gibt keine langen 
      Tiertransporte, keine Gentechnik. Die Produkte werden möglichst in der näheren 
      Umgebung verkauft, beispielsweise 37_________ Wochenmärkten oder in 
      Bio-Supermärkten. Außerdem dürfen weder Kunstdünger noch chemische 
      Schädlingsbekämpfungsmittel 38_________ werden.
      Wenn die Bio-Lebensmittel weiterverarbeitet werden - beispielsweise aus Bio-Eiern, 
      Bio-Mehl und Bio-Zucker ein Bio-Kuchen gebacken wird -, dürfen 39_________ nur 
      Bio-Lebensmittel benutzt werden.
      Für Bio-Produkte gibt es übrigens auch ein Zertifikat, das Bio-Siegel. Diese Richtlinien 
      garantieren, 40_________ die Produkte wirklich “bio” sind`,
    },
  ],
  Answers: [
    {

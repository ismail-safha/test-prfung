...
Beschäftigten in Großraumbüros deutlich höher als bei anderen.
  ...
  questions: [
    {
      id: 0,
      questionText: "Eine Studie aus der Schweiz...",
      options: [
        {
          optionID: "A",
          option:
    ...
    {
      id: 1,
      questionText: "Großraumbüros…",
      options: [
        { optionID: "A", option: "reduzieren den Krankenstand" },
    ...
    {
      id: 2,
      questionText: "Die deutschen Angestellten…",
      options: [
        { optionID: "A", option: "bevorzugen Einzelbüros." },
        {
          optionID: "B",
          option: "genießen eine individuell ausgewählte Büromöblierung",
        },
    ...
    {
      id: 3,
      questionText: "Die Arbeitsplatzfläche…",
      options: [
        {
          optionID: "A",
          option:
        ...
        {
          optionID: "B",
          option: "schließt die gemeinsam genutzten Flächen aus",
        },
        {
          optionID: "C",
          option: "wird in London oft unter mehreren Mitarbeitern aufgeteilt",
        },
      ],
      correctAnswerID: "C",
    },
    {
      ...
      options: [
        ...
        {
          optionID: "B",
          option: "werden bald in 40% der deutschen Firmen eingeführt.",
        },
        {
          optionID: "C",
  ...
  texts: [
    {
      ...
      spätestens wenn wieder einmal ein Skandal in den Nachrichten ist.

       32_________ sind Bio-Produkte teurer - und den Aufpreis will man nur zahlen, wenn man sicher ist, dass 
      ...
      eine eindeutige Auskunft: Bio-Lebensmittel sind gesünder.
      
      Sie 33_________ weniger 
      Nitrat, mehr Nährstoffe und sind besser geeignet, wenn man Allergien hat.
      Doch Bio-Lebensmittel sind nicht nur gut für die Gesundheit. 
      
      Bei vielen Verbrauchern steht 34_________ ihrem Einkaufsverhalten ein ökologisches Bewusstsein. 
      Bio-Verbraucher machen sich Gedanken über die Herkunft der Lebensmittel, denn auch 
      die umweltfreundliche Landwirtschaft ist besser für Tiere und Pflanzen, 

      kurz: Sie 35_________ unsere Umwelt. Und viele Bio-Verbraucher wollen als gesunde Menschen in 
      ...
      Die Mindestrichtlinien der Bio-Landwirtschaft beinhalten eine 
      ...
      Außerdem dürfen weder Kunstdünger noch chemische 

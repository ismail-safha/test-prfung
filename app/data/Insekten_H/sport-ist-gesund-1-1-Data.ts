  ...
  carts: [
    {
      ...
      cartItemAnswers: "",
      cartAcoordion: "Ein Leistungssport für jedes Alter",
    },
    {
      id: 1,
    ...
    },
    {
      ...
      Ausdauertraining`,
      cartItemAnswers: "",
      cartAcoordion: "Fitness auch mit wenig Zeitaufwand erreichbar",
    },
    {
      id: 3,
  ...
  carts: [
    {
      ...
      cartItemAnswers: "",
      cartAcoordion:
        "Sie möchten mit Ihrer zwölfjährigen Tochter ein altersgerechtes Theaterstück sehen.    ",
    },
    {
      // B
      id: 1,
      ...
      |Rasmus ist in einem Kinderheim aufgewachsen, er hat keine Eltern. Eines Tages läuft er davon und will sich Eltern suchen. Die erste Nacht schläft er in einer Scheune im Stroh, und am Morgen entdeckt er neben sich Oskar. Oskar ist ein Landstreicher, der keine Wohnung hat. Zuerst hat Rasmus Angst vor ihm, aber schon bald merkt er, dass Oskar ein prächtiger Mensch ist. Gemeinsam suchen sie Eltern für Rasmus. Doch als sie endlich prima Eltern gefunden haben, da wollen die beiden sich nicht mehr trennen.
       `,
      cartItemAnswers: "",
      cartAcoordion:
        "Sie möchten zusammen mit ihrem Kleinen Neffen einen Kinderfilm sehen",
    },
    {
      // C
      id: 2,
      title: `Claus von Wagner: Im Feld
      Die Verfilmung des Buches "Im Feld" handelt von einem jungen Mann, der bisher mit den Wölfen geheult hat. Er hat stets gemacht, was alle gemacht haben, und sich nach der Mehrheit gerichtet: Führerschein. Studium, Beruf. Freundin, iPod. In dieser Reihenfolge. Nun soll er plötzlich Vater werden. Doch der Antiheld ergreift die Flucht, um nachzudenken. Verfolgt von städtischen Beamten, der Polizei, den Reportern eines regionalen Hörfunksenders und seinen eigenen Ängsten, stürzt er sich in pointenreiche Analysen des Weltzustandes...
    ...
    },
    {
      ...
      id: 3,
      title: `
      Geschlossene Gesellschaft: Drama von Jean-Paul-Sartre
      Drei Personen, ein Mann und zwei Frauen, werden nach ihrem Tod in einem Zimmer eingesperrt, das keiner der drei jemals wieder verlassen und niemand anderes je betreten wird: Der Ort des Geschehens ist die Hölle. Alle drei sind sich bewusst, dass sie sich in der Hölle befinden, und machen sich auf das Schlimmste gefasst, aber die erwartete Folter und die körperlichen Qualen stellen sich nicht ein, nur eine leichte Hitze ist zu verspüren. Tastend versuchen Sie, voneinander den Grund für die Höllenfahrt zu erfahren, ohne jedoch ihre eigene Schuld zu offenbaren.
    ...
    },
    {
      ...
      Im Dezember 1770 erblickte Ludwig von Beethoven in der Bonngasse 20 das Licht der Welt. Wer ahnte damals, dass mit ihm ein musikalisches Genie geboren wurde, dessen Musik heute in aller Welt bekannt ist? Bis 1792 lebte Beethoven in Bonn, bevor er nach Wien ging und zu einem der berühmtesten 11 Komponisten der Welt wurde. Es werden Orte und Plätze aufgesucht, wo der weltberühmte Komponist wirkte und die faszinierende Einblicke in das Alltagsleben dieses großen Bonners ermöglichen. Datum: 01.12. bis 31.12., Ort: Touristeninformation`,
      cartItemAnswers: "",
      cartAcoordion: `Ihre Schwester interessiert sich für die Biographien großer Musiker.`,
    },
    {
      // F
      id: 5,
      title: `Radtour am Rhein
      Hinweis: Diese Tour ist nur von Gruppen auf Anfrage buchbar! Die Fahrräder sind mitzubringen. Die Tour wird vom ADFC angeboten und verläuft am Rhein, einem der geschichtsträchtigsten Flüsse der Welt. Er symbolisiert wie für viele Rheinanwohner auch für Bonn über Jahrhunderte hinweg bis auf den heutigen Tag die Lebensader der Stadt. Entlang des linksrheinischen Rheinufers sprechen die steinernen Zeitzeugen der Bonner Geschichte für sich, wobei auch die zukunftsweisenden Aspekte der Stadt nicht zu kurz kommen.
      1
      Datum: 01.02. bis 31.12.
      1
      Ort und Uhrzeit: nach Vereinbarung`,
      cartItemAnswers: "",
      cartAcoordion:
        "Sie wollen eine Stadtbesichtigung mit ein wenig Sport verbinden",
    },
    {
      // G
      id: 6,
      title: `Weihnachtsmarkt in Koblenz
      Über 100 festlich geschmückte Holzhäuschen, der Duft von Lebkuchen und Glühwein liegt in der Luft. Weihnachtsmelodien erklingen im malerischen Ambiente der historischen Altstadt unweit der Einkaufsstraßen: Das ist der Koblenzer Weihnachtsmarkt 2007. Alles, was das Herz in der Weihnachtszeit begehrte, findet sich hier wieder, denn auch in diesem Jahr warten wieder ein umfangreiches Angebot an Kunsthandwerk und Weihnachtsschmuck und eine riesige Auswahl an Geschenkartikeln auf die Besucher. Abgerundet durch Weihnachtsbäckerei und viele Attraktionen, wird der Besuch auf dem Koblenzer Weihnachtsmarkt zu einem Erlebnis, das Sie sich nicht entgehen lassen sollen.
      Datum: 23.11.-23.12..
    ...
    },
    {
      ...
      Im Jahr 1 machten sich drei Flöhe aus Deutschland auf den Weg nach Israel, um einmal so richtig zu entspannen. Leider war zu diesem Zeitpunkt eine Volkszählung im vollen Gange und die einzige Übernachtungsmöglichkeit fanden sie in einem Stall bei Bethlehem. Dass sie diese Unterkunft auch noch mit einem kleinen Kind teilen müssten, damit rechnete keiner der drei Flöhe. Und dass dieses Kind auch
      19 noch eine Berühmtheit war, machte die ganze Sache für die drei Flöhe zu einem aufregenden Abenteuer.
      14
      Dieses neue Kinderstück aus der Feder von Dirk Zimmer erzählt die Weihnachtsgeschichte auf humorvolle und gefühlvolle Weise aus der Sicht der drei Flöhen.
      Datum: 26.11.-22.12.. Uhrzeit: jeweils, 15.00 Uhr. Ort: Innenhof des Rathauses.
      Alter:ab-5-Jahre`,
      cartItemAnswers: "",
      cartAcoordion:
        "Sie wollen mit ihren Kindern eine etwas andere, eher lustige Seite von Weihnachten erleben.",
    },
    {
      // I
      id: 8,
      title: `
      Weihnachtsshow
      "Stille Nacht" trifft "Last Christmas". Gospel umarmt Soul, und Pop küsst Klassik. Als 1997 die Idee entstand, eine Weihnachtsshow zu entwickeln, die die schönsten Weihnachtslieder aller Zeiten und alter Genre in sich vereint: konnte sich keiner so recht vorstellen, dass diese Show einmal zur erfolgreichsten Weihnachtsshow Deutschlands avancieren würde. Seit zehn Jahren begeistert nun die Band "Christmast Moments von Thomas Schwab & Band das Publikum sowohl in den großen Konzerthallen der Republik (unter anderem Arena Trier, Phönixhalle Mainz) als auch vor den Fernsehern (ARD-Ausstrahlungen seit 2004). "Christmas Moments trifft mitten ins Herz und konnte in den letzten Jahren mehr als 500.000 Zuschauer begeistern.
      Datum: 11.12., Uhrzeit: 20.00 Uhr.
      Ort: Rhein-Mosel-Halle`,
      cartItemAnswers: "",
      cartAcoordion: " Sie möchten alte und neue Weihnachtslieder hören",
    },
    {
      // J
      id: 9,
      title: `Lasse Lindgren Ensemble
      Jazz vom Feinsten mit durchaus gewollten konservativen Zügen. Der Trompeter Lasse Lindgren ist einer der innovativen Spitzen-Trompeter der aktuellen Jazzszene in Schweden, der in vielen internationalen Bigbands und zusammen mit anderen berühmten Jazzmusikern gespielt hat. Von der Tageszeitung "Svenska Dagbladet wurde er als einer der kompetentesten Trompetenspieler dieses Landes" bezeichnet und Randy Brecker schrieb: "Es ist so erfrischend, etwas zu hören, was wirklich originell ist! 12 Lass Lindgren. Du bist ein wundervoller Spieler und Komponist". Sein neuestes Projekt ist ein Glaubensbekenntnis an die Kraft und Energie des Jazz mit eigener Handschrift: Lasse Lindgren hat eine virtuose, immer transparente Hingabe zu seinem Instrument.
      Datum: 1.11., Uhrzeit: 19.00 Uhr.
      Ort: Irish Pub im Stadtzentrum`,
      cartItemAnswers: "",
      cartAcoordion: "Sie leben Auftritte von herausragenden Musik.",
    },
    {
      // K
      id: 10,
      title: ` 10 Jahre FÜR DIE KATZ
      Unglaublich! 10 Jahre ist es bereits her. seit FÜR DIE KATZ wie ein Faustschlag ins Licht der Öffentlichkeit traten und sich binnen kürzester Zeit in die Spitzenriege der deutschen Komiker katapultierten. Heute befinden sich die beiden mit Preisen überhäuften Weltbürger Benno Rex und Karl 20 Salzburger auf dem vorläufigen Höhepunkt ihrer eindrucksvollen Karriere und gelten als die
      13
      vielseitigsten, kreativsten und für Presse wie Fans schlichtweg lustigsten Komödianten Deutschlands. Ihre Wortschöpfungen und Charaktere erweisen sich immer wieder als richtungsweisende Leitsterne für die gesamte Comedy-Branche.
    ...
    },
    {
      //L
      id: 11,
      title: `Weihnachtsvarieté im Café Spitz
      Das Weihnachtsvarieté erwartet Sie auch in diesem Jahr mit atemberaubender Akrobatik, traumhafter Jonglage, ergänzt von Livemusikern. Seien Sie dabei und staunen Sie vielleicht mit ihrer Familie, mit ihren Lieblingskollegen oder der ganzen Firma oder einfach nur mit ihrem oder Ihrer Liebsten. Karl-Heinz Helmschrot hat auch in diesem Jahr wieder eine faszinierende Gruppe von sehr unterschiedlichen Künstlern zusammengestellt. Zum 10-jährigen Jubiläum - 10 Künstler! Nicht zuständig ist er für Ihr leibliches Wohl! Dafür haben die Köche des Café Spitz wieder eine internationale Karte zusammengestellt, also freuen Sie sich auf Köstlichkeiten aus aller Welt. Datum: 9.12. Uhrzeit: 21.00 Uhr, Ort: Café Spitz`,
      cartItemAnswers: "",
      cartAcoordion: `Sie möchten in Dezember essen gehen und ein buntes, künstlerisches Programm genießen`,
    },
  ],
  answers: [
    // 11
    `
    Ihre Schwester interessiert sich für die Biographien großer Musiker.`,
    // 12
    "Sie leben Auftritte von herausragenden Musik.",
    // 13
    "Sie möchten in Dezember essen gehen und ein buntes, künstlerisches Programm genießen",
    // 14
    "Sie möchten alte und neue Weihnachtslieder hören",
    // 15
    "Sie möchten mit Ihrer zwölfjährigen Tochter ein altersgerechtes Theaterstück sehen.    ",
    // 16
    "Sie möchten zusammen mit ihrem Kleinen Neffen einen Kinderfilm sehen",
    ...
    "Sie wollen eine Stadtbesichtigung mit ein wenig Sport verbinden",
    // 18
    "X: Sie wollen ihrem Freund, der Tanztheater liebt, eine Eintrittskarte zum Geburtstag schenken.",
    // 19
    "Sie wollen mit ihren Kindern eine etwas andere, eher lustige Seite von Weihnachten erleben.",
    //20
    "Sie wollen mit Bekannten ausgehen um mal wieder herzhaft lachen.",
...
export const lesenTeil_2 = {
  ...
  aufgabens: [
    {
      id: 0,
      qustion: "In Deutschland *(gibst es)",
      answersOne: ` existiert eine Vielzahl von Kaffeeröstereien.`,
      answersTwo:
        "gibt es nur noch wenige traditionelle Kaffeeröstereien. *(gering Zahl)",
      answersThree:
        "handeln nur noch internationale Gesellschaften mit Kaffee.",
    },
    {
      id: 1,
      qustion: "Für die Kaffeerösterei Münchhausen",
      answersOne: `ist es nicht von Bedeutung, ob der Kaffee von Kleinbauern oder Großplantagen kommt.`,
      answersTwo: "spielt der günstige Einkaufspreis eine wichtige Rolle.",
      answersThree:
        "steht eher die Qualität des Kaffees als der Preis im Vordergrund.        ",
    },
    {
      id: 2,
      qustion: "Kaffeebohnen",
      answersOne: `dürfen nach dem Rösten zwar zu dunken sein, aber nicht zu hell.
      `,
      answersTwo:
    ...
    {
      id: 3,
      qustion: " Die gerösteten Kaffeebohnen werden",
      answersOne: `im Kontor nur an Stammkunden angegeben`,
      answersTwo: "in Handarbeit gemischt",
      answersThree:
        "zusätztlich online vermarktet. *(in unterschiedlichen Geschmackrichtungen verkauft)",
    },
    {
      id: 4,

      qustion: " In Zukunft wollen die Besitzer",
      answersOne: `die Kaffeerösterei in ein Museum umwandeln.`,
      answersTwo: "ein Museum über den Kaffeeanbau eröffnen.",
      answersThree: "keinen Röstkaffee mehr verkaufen.",
    },
  ],
};
